		...
		<div class="col-lg-5 col-md-5 col-md-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<a href="/register"><button class="btn btn-primary pull-right">{{__
							('auth.register')}}</button></a>
				</div>
			</div>
			<div></div>
		</div>
							...
							<div class="form-check">
								<div class="text-right text-danger">
									<a class="btn btn-link" href="{{ route('password.request') }}">
										{{__ ('auth.passwordForgotten')}} </a>
								</div>
							</div>
						</div>
						<div class="panel-body">
							<button type="button" class="btn btn-fb">
								<i class="fa fa-facebook pr-1"></i> {{__
								('auth.loginFacebook')}}
							</button>
							<button type="submit" class="btn btn-primary pull-right">{{__
								('auth.login')}}</button>
						</div>
					</form>
				</div>

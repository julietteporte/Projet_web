...
<div class="container" id="main">
	...
	<br /> <strong>La seule contrepartie à l'utilisation de ces mentions
		légales, est l'engagement total à laisser le lien crédit subdelirium
		sur cette page de mentions légales.</strong><br /> Vos mentions
	légales :
	...
	<p>
		...
		du site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>
		l'identité des différents intervenants dans le cadre de sa réalisation
		et de son suivi :
	</p>
	<p>
		<strong>Propriétaire</strong> : Groupe NDP – – 264 Boulevard Godard,
		33300 Bordeaux<br /> <strong>Créateur</strong> : <a
			href="http://www.BDECesiBordeaux.fr/">BDE Cesi Bordeaux</a><br /> <strong>Responsable
			publication</strong> : Groupe NDP – groupeNDP@exemple.com<br /> Le
		responsable publication est une personne physique ou une personne
		morale.<br /> <strong>Webmaster</strong> : Navarrot-Lavigne –
		axel.navarrotlavigne@viacesi.fr<br /> <strong>Hébergeur</strong> : OVH
		– 42 Rue de Tauzia, 33800 Bordeaux<br /> Crédits : NAVARROT-LAVIGNE
		Axel PORTE Juliette DUTHIEUW Marine<br />
	</p>

	<h3>2. Conditions générales d’utilisation du site et des services
		proposés.</h3>
	<p>
		L’utilisation du site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>
		...
		utilisateurs du site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>
	...
	<p>Ce site est normalement accessible à tout moment aux utilisateurs.
		...
		toutefois décidée par Groupe NDP, qui s’efforcera alors de communiquer
		préalablement aux utilisateurs les dates et heures de l’intervention.</p>
	<p>
		Le site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>
		est mis à jour régulièrement par Groupe NDP. De la même façon, les
	...
	<p>
		Groupe NDP s’efforce de fournir sur le site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a> des
	...
	<p>
		Tous les informations indiquées sur le site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a> sont
		données à titre indicatif, et sont susceptibles d’évoluer. Par
		ailleurs, les renseignements figurant sur le site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a> ne
	...
	<p>Groupe NDP est propriétaire des droits de propriété intellectuelle
	...
	<p>Groupe NDP ne pourra être tenue responsable des dommages directs et
		indirects causés au matériel de l’utilisateur, lors de l’accès au site
		www.BDECesiBordeaux.fr, et résultant soit de l’utilisation d’un
	...
	<p>
		Groupe NDP ne pourra également être tenue responsable des dommages
		indirects (tels par exemple qu’une perte de marché ou perte d’une
		chance) consécutifs à l’utilisation du site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>.
	</p>
	<p>Des espaces interactifs (possibilité de poser des questions dans
		l’espace contact) sont à la disposition des utilisateurs. Groupe NDP
		...
		protection des données. Le cas échéant, Groupe NDP se réserve
	...
	<p>
		...
		desquels l'utilisateur a accédé au site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>, le
		fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
		(IP) de l'utilisateur.
	</p>
	<p>
		En tout état de cause Groupe NDP ne collecte des informations
		personnelles relatives à l'utilisateur que pour le besoin de certains
		services proposés par le site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>.
	...
	<p>
		...
		rachat de Groupe NDP et de ses droits permettrait la transmission des
		...
		vis à vis de l'utilisateur du site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>.
	</p>
	<p>Le site n'est pas déclaré à la CNIL car il ne recueille pas
		d'informations personnelles. .</p>
	<p>Les bases de données sont protégées par les dispositions de la loi
	...
	<p>
		...
		mis en place avec l’autorisation de Groupe NDP. Cependant, Groupe NDP
	...
	<p>
		La navigation sur le site <a href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a>
	...
	<p>Le refus d’installation d’un cookie peut entraîner l’impossibilité
		...
		cookies :</p>
	<p>Sous Internet Explorer : onglet outil (pictogramme en forme de
	...
	<p>
		Tout litige en relation avec l’utilisation du site <a
			href="http://www.BDECesiBordeaux.fr/">www.BDECesiBordeaux.fr</a> est

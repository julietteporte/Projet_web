          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="add_product" role="button" class="btn btn-primary">{{__ ('administration.createArticle')}}</input>
                </div>
              </form>
            </div>
          </div>
                ...
                <div class="panel-body">
                  ...
                  <div class="modal" id="addCate" tabindex="-1" role="dialog" aria-labelledby="addCateLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                          <div class="panel-body">
                            <form method="POST">
                              <div class="form-row col-lg-4 col-md-4">
                                <div class="form-group">
                                  <label for="validationServer03">{{__('administration.entitled')}}</label> <input type="text" class="form-control is-invalid" id="validationServer03" required>
                                </div>
                              </div>
                            </form>
                          </div>
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" role="button" class="btn btn-primary">{{__('administration.createArticle')}}</button>
                      </div>
                    </div>
                  </div>

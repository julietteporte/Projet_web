				...
				<form method="POST">
					<div class="form-row col-lg-6 col-md-6">
						<div class="form-group">
							<label for="validationServer03">{{__ ('suggestionBox.entitled')}}</label> <input
								type="text" class="form-control is-invalid"
								id="validationServer03" required>
						</div>
						<div class="form-group">
							<label for="validationServer04">{{__ ('suggestionBox.place')}}</label> <input type="text"
								class="form-control is-invalid" id="validationServer04" required>
						</div>
						<div class="form-group col-lg-7 col-md-7">
							<label for="validationServer04"><span
								class="glyphicon glyphicon-calendar"></span>{{__ ('suggestionBox.date')}}</label> <input
								type="date" class="form-control is-invalid"
								id="validationServer04" required>
						</div>
						<div class="form-group col-lg-5 col-md-5">
							<label for="validationServer04 "><span
								class="glyphicon glyphicon-euro"></span>{{__ ('suggestionBox.price')}}</label><input
					...
					<div class="form-row col-lg-6 col-md-6">
						...
						<div class="panel-body text-center">
							<button class="fa fa-share btn" role="button" type="submit">{{__ ('suggestionBox.submit')}}</button>
						</div>
					</div>
				</form>
			</div>
